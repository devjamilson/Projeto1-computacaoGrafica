...
if __name__ == "__main__":
    root = ctk.CTk()
    plane = CohenSutherland(root, width=600, height=600)
    plane.pack()

    # Definindo os pontos das extremidades da janela
    p1 = (-2, -1)  # Extremidade inferior esquerda
    p2 = (3, 2)    # Extremidade superior direita

    # Desenhando a janela com os pontos fornecidos
    plane.draw_window(p1, p2)
